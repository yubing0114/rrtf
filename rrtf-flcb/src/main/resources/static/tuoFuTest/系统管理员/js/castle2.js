...
$(function() {
	...
	function showLesson(d) {
		$("#lessonTable").append('<tr><td><input type="checkbox" name="" id="" value="" /></td><td><a style="color: red;" href="###">'+d.lessonTitle+'</a></td><td>'+d.activityType+'</td><td>'+d.lessonType+'</td><td>'+d.teacher.realname+'</td><td>'+d.startDate+'</td><td>'+d.endDate+'</td><td>每周:'+d.dayOfWeek+'</td><td>'+d.startTime+'-'+d.startTime+'</td><td>'+d.lessonPrice+'</td></tr>');
	}
